			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/utente/editRuolo/${utenteItem.id }">Modifica Ruolo</a>
											<a class="btn  btn-sm btn-outline-warning ml-2 mr-2" href="${pageContext.request.contextPath}/utente/resetDefaultPassword/${utenteItem.id }">Reset Password	</a>
