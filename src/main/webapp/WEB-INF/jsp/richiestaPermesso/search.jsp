	  ...
	  <div class="container">
			...
			<div class='card'>
			    ...
			    <div class='card-body'>
						...
						<form:form modelAttribute="search_richiesta_attr" method="post" action="list" novalidate="novalidate" class="row g-3">
							...
							<div class="col-md-12">
								...
								<sec:authorize access="!(hasRole('DIPENDENTE_USER'))">
									<div class="col-md-6 form-check" id="dipDivId">
										<p>Dipendente:</p>
										<form:radiobuttons itemValue="id" itemLabel="nome"  element="div class='form-check'" items="${search_richiesta_dipendente_attr}" path="dipendenteId" />
									</div>
									<script>
